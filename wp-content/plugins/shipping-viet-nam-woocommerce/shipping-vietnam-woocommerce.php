...
define( 'SVW_CITIES', svw_url_get_contents( SVW_DIR.'assets/json/cities.json') );
define( 'SVW_DISTRICTS', svw_url_get_contents( SVW_DIR.'assets/json/districts.json') );
define( 'SVW_WARDS', svw_url_get_contents( SVW_DIR.'assets/json/wards.json') );
...
function svw_url_get_contents($url) {
